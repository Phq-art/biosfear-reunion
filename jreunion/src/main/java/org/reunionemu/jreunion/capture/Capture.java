...
public class Capture extends Thread{
	...
	private final HashMap<Integer,Integer> maps = new HashMap<Integer,Integer>();
	private final HashMap<Integer,SocketChannel> localRoutes = new HashMap<Integer,SocketChannel>();
	private final HashMap<Integer,SocketChannel> remoteRoutes = new HashMap<Integer,SocketChannel>();
	private final HashMap<Integer,OtherProtocol> protocols = new HashMap<Integer,OtherProtocol>();
	private final HashMap<Integer,OtherProtocol> remoteProtocols = new HashMap<Integer,OtherProtocol>();
